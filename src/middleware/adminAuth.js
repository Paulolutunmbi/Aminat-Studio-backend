...
module.exports = {
  requireAdminSession,
  // Existing protected resource routes use this name. It is intentionally the
  // same session check; there is no forced-password-change gate.
  requireAdminAuth: requireAdminSession,
};
